...
const WelcomeCard = () => {
  return (
    <div className="dashboard-card p-6 flex flex-col md:flex-row items-center overflow-hidden relative">
      <div className="md:w-1/2 z-10">
        ...
        <button className="flex items-center gap-2 text-xs text-white/70 hover:text-white">
          <span>Tap to record</span>
          <ArrowRight size={14} />
        </button>
      </div>
      <div className="md:w-1/2 h-48 flex items-center justify-center overflow-hidden">
        <img 

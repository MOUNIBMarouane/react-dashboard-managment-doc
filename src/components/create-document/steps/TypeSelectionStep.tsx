    ...
    <div className="space-y-6">
      <div className="space-y-3">
        <Label
          ...
          className={`text-sm font-medium ${
            isLightMode ? "text-blue-800" : "text-gray-200"
          }`}
        >
          Document Type*
        </Label>
        ...
        >
          <SelectTrigger
            className={`h-12 text-base ${
              isLightMode
                ? "bg-white border-blue-200 text-blue-900 hover:border-blue-300 shadow-sm"
          ...
          >
            {documentTypes.map((type) => (
              <SelectItem
                ...
                className={isLightMode ? "text-blue-900" : "text-gray-200"}
              >
            ...
            <div className="ml-3">
              ...
              <div
                className={`mt-2 text-sm ${
                  isLightMode ? "text-blue-600" : "text-blue-200"
                }`}
              >
                <p>
              ...
              <div className="mt-4">
                <Button
                  ...
                  className={
                    isLightMode
                      ? "border-blue-300 text-blue-700 hover:bg-blue-50 shadow-sm"
      ...
      <div className="space-y-3">
        ...
        <Input
          ...
          className={`h-12 text-base ${
            isLightMode
              ? "bg-white border-blue-200 text-blue-900 placeholder:text-gray-400 shadow-sm"
